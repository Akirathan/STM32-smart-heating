...
Project is written in C++ and uses [HAL library](http://www.st.com/en/embedded-software/stm32cubef1.html), **documentation** (generated by Doxygen) is accessible from [here](https://akirathan.github.io/STM32-smart-heating/).
